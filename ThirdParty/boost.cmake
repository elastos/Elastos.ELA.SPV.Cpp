...
if (SPV_FOR_IOS)
	set(Boost_INCLUDE_DIRS ${CMAKE_CURRENT_SOURCE_DIR}/twilio-boost-build/src/boost/1.67.0)
else()
...
foreach(COMPONENT_NAME ${BOOST_BUILD_COMPONENTS})
	...
	elseif(SPV_FOR_IOS)
		set(COMPONENTS_LIBRARY_PATH ${COMPONENTS_LIBRARY_PATH} ${CMAKE_CURRENT_SOURCE_DIR}/twilio-boost-build/target/outputs/boost/1.67.0/ios/lib/release/arm64-v8a/libboost_${COMPONENT_NAME}.a)
	else()
...
foreach(COMPONENT_NAME ${BOOST_BUILD_COMPONENTS})
	...
	elseif(SPV_FOR_IOS)
		set(COMPONENT_LIBRARY_PATH ${CMAKE_CURRENT_SOURCE_DIR}/twilio-boost-build/target/outputs/boost/1.67.0/ios/lib/release/arm64-v8a/libboost_${COMPONENT_NAME}.a)
	else()
